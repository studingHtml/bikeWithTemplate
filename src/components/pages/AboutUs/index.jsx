            ...
            <div className="col-sm-6 col-lg-3">
              <div className="hover-team">
                <div className="our-team"> <img src="images/img-1.jpg" alt="" />
                  ...
                  <ul className="social">
                  <li>
                        <a href="https://www.facebook.com/" className="fab fa-facebook">Facebook</a>
                    </li>
                    <li>
                      <a href="https://twitter.com/twister" className="fab fa-twitter">Twister</a>
                    </li>
                    <li>
                      <a href="https://mail.google.com/mail" className="fab fa-google-plus" >Google</a>
                    </li>
                    <li>
                      <a href="https://www.youtube.com/" className="fab fa-youtube" >Youtube</a>
                    </li>
                  </ul>
                  <div className="icon"> <i className="fa fa-plus" aria-hidden="true" /> </div>
                </div>
